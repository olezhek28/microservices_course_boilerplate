...
type UserV1Client interface {
	...
	Updated(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *userV1Client) Updated(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/user_v1.UserV1/Updated", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserV1Server interface {
	...
	Updated(context.Context, *UpdateRequest) (*emptypb.Empty, error)
...
func (UnimplementedUserV1Server) Updated(context.Context, *UpdateRequest) (*emptypb.Empty, error) {
...
func _UserV1_Updated_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserV1Server).Updated(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_v1.UserV1/Updated",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserV1Server).Updated(ctx, req.(*UpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserV1_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Updated",
			Handler:    _UserV1_Updated_Handler,
		},
		{
			MethodName: "Delete",
